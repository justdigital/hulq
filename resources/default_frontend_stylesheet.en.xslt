...
<select name="site">
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='_google_social_userprofile_collection')]">
   <option value="_google_social_userprofile_collection" selected="selected">_google_social_userprofile_collection</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="_google_social_userprofile_collection">_google_social_userprofile_collection</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='comunidades')]">
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='imagens')]">
   <option value="imagens" selected="selected">imagens</option>
  </xsl:when>
  <xsl:otherwise>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='pessoas')]">
   <option value="pessoas" selected="selected">pessoas</option>
  </xsl:when>
  <xsl:otherwise>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='portal_corporativo')]">
   <option value="portal_corporativo" selected="selected">portal_corporativo</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="portal_corporativo">portal_corporativo</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='premio_destaque')]">
   <option value="premio_destaque" selected="selected">premio_destaque</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="premio_destaque">premio_destaque</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='publicacoes')]">
   <option value="publicacoes" selected="selected">publicacoes</option>
  </xsl:when>
  <xsl:otherwise>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='tudo')]">
   <option value="tudo" selected="selected">tudo</option>
  </xsl:when>
  <xsl:otherwise>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='videos')]">
   <option value="videos" selected="selected">videos</option>
  </xsl:when>
  <xsl:otherwise>
